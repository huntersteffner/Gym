...
const Calendar = () => {
  ...
  const mondayClasses = GroupClassesData[0].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
  const tuesdayClasses = GroupClassesData[1].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
  const wednesdayClasses = GroupClassesData[2].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
  const thursdayClasses = GroupClassesData[3].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
  const fridayClasses = GroupClassesData[4].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
  const saturdayClasses = GroupClassesData[5].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
  const sundayClasses = GroupClassesData[6].classes.map((item) => (<CalendarItem key={item.id} time={item.time} text={item.text} />))
